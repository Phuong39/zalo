							    ...
							    <div class="col-md-12">
							        ...
							        <div class="row">
							            ...
							            <div class="col-md-12">
							                ...
							                <a data-toggle="modal" data-target="#modalnangcao" style="margin-top: 15px !important; color: #FFFF;" class="btn btn-primary sendnangcao"><i class="icon-cogs mr-3"></i>Đăng bài nâng cao</a>
							            </div>
					       ...
					       <!-- Modal Header -->
					        ...
					        <div class="modal-body">
					        	 <div class="row">
							      ...
							      <div class="col-md-6 ml-auto"  style="text-align: center;" >Chọn thể loại chiến dịch</div>
							    </div>
					          	
					          	
					          	
					        </div>
					        <p style="color: red">Chú ý: Tính năng đang phát triển, bạn vui lòng quay lại sau.</p>
					        <!-- Modal footer -->
					        <div class="modal-footer">
					          <button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
