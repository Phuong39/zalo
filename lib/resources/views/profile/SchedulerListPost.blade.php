           ...
           @include('errors.note')
				...
				<div class="col-md-12">
				    <div class="card">
				        ...
				        <form method="GET">
				            <div class="row">
				                <div class="col-md-2"><button class="btn btn-danger" type="button" onclick="deleteScheduleProfile()"><i class="icon-folder-remove mr-3 icon-1x"></i> Xóa </button></div>
				                <div class="col-md-5">
				    ...
				    <div class="col-md-12">
				        <div class="card">
					        <div class="card-header header-elements-inline bg-slate-800">
					            <h5 class="card-title">Danh sách lịch đăng profile</h5>
					            {{ csrf_field() }}
					        </div>
					       <div class="table-responsive">
					                    ...
					                    <tr>
					                        <th>
												...
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input-styled-warning" data-fouc onclick="checkAllCheckboxscheduleProfile(this)">
					                ...
					                <tbody>
                                      @foreach($history as $row)
					                       <tr>
					                        <td>
					                       <div class="form-check form-check-inline formScheProfile">
											<label class="form-check-label">
            ...
            <script>
            	function deleteScheduleProfile(){
					var arr = [];
					 ...
					 $.ajax({
						        url: '{{ url("profile/deleteSchedulePrf")}}',
						        dataType: 'json',
						        type: 'post',
